                            ...
                            IconButton(
                              icon: StreamBuilder<DocumentSnapshot>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return Icon(
                                    updatedGarbage.likes.contains(userId) ? Icons.thumb_up : Icons.thumb_up_outlined,
                                    color: Colors.green,
                                  );
                                },
                              ),
                              onPressed: () => dataSource.likeGarbage(garbage.id!, userId),
                            ),
                            ...
                            IconButton(
                              icon: StreamBuilder<DocumentSnapshot>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  final updatedGarbage = Garbage.fromJson(snapshot.data!.data() as Map<String, dynamic>);
                                  return Icon(
                                    updatedGarbage.dislikes.contains(userId) ? Icons.thumb_down : Icons.thumb_down_outlined,
                                    color: Colors.red,
                                  );
                                },
                              ),
                              onPressed: () => dataSource.dislikeGarbage(garbage.id!, userId),
                            ),
                          ],
                        )
                      ]),
